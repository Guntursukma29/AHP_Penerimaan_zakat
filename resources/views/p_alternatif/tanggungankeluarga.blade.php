...
@section('content')
    <div class="card">
        <h5 class="text-center mt-4">PERBANDINGAN TANGGUNGAN KELUARGA</h5>
        <div class="card-body">
            <div class="table-responsive text-nowrap">
                <form action="{{ url('/submit-perbandingantanggungankeluarga') }}" method="POST">
                    @csrf
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">
                                                        {{ $k1->nama }}
                                                        @if ($k1->subKriteria->isNotEmpty())
                                                            ||
                                                            @foreach ($k1->subKriteria as $sub)
                                            ...
                                            <td>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">
                                                        {{ $k2->nama }}
                                                        @if ($k2->subKriteria->isNotEmpty())
                                                            ||
                                                            @foreach ($k2->subKriteria as $sub)
                                                                {{ $sub->sub_kriteria_name }}
                                                            @endforeach
                                                        @endif
                                                    </label>
