...
class PerbandinganKondisiKesehatanController extends Controller
{
    public function index()
    {
        ...
        $this->fillMatrixAndColumnTotals($perbandinganKondisiKesehatan, $matrix, $columnTotals, $idToIndex);
    ...
    private function fillMatrixAndColumnTotals($perbandinganKondisiKesehatan, &$matrix, &$columnTotals, $idToIndex)
    {
