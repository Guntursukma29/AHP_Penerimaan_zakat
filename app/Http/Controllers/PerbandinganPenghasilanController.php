...
class PerbandinganPenghasilanController extends Controller
{
    public function index()
    {
        ...
        $this->fillMatrixAndColumnTotals($perbandinganPenghasilan, $matrix, $columnTotals, $idToIndex);
    ...
    private function fillMatrixAndColumnTotals($perbandinganPenghasilan, &$matrix, &$columnTotals, $idToIndex)
    {
