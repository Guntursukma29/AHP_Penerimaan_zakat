...
class PerbandinganTempatTinggalController extends Controller
{
    public function index()
    {
        ...
        $comparisonResults = ComparisonHelper::calculateComparison($size, $penerimaZakat, $perbandinganTempatTinggal);
        ...
        $perbandinganArray = ComparisonHelper::getPerbandinganArray($perbandinganTempatTinggal);
