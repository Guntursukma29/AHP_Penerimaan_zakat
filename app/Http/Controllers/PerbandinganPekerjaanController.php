...
class PerbandinganPekerjaanController extends Controller
{
    public function index()
    {
        ...
        $this->fillMatrixAndColumnTotals($perbandinganPekerjaan, $matrix, $columnTotals, $idToIndex);
    ...
    private function fillMatrixAndColumnTotals($perbandinganPekerjaan, &$matrix, &$columnTotals, $idToIndex)
    {
