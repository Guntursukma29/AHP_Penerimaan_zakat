...
class PerbandinganPekerjaanController extends Controller
{
    public function index()
    {
        ...
        $this->fillMatrixAndColumnTotals($perbandinganPekerjaan, $matrix, $columnTotals);
        ...
        $perbandinganArray = $this->getPerbandinganArray($perbandinganPekerjaan);

        return view('p_alternatif.pekerjaan', compact('penerimaanzakat', 'matrix', 'columnTotals', 'normalizedMatrix', 'eigenVector', 'lambdaMax', 'ci', 'cr', 'sumEigenVector', 'perbandinganArray', 'kriteria'));
    }
    ...
    private function fillMatrixAndColumnTotals($perbandinganPekerjaan, &$matrix, &$columnTotals)
    {
    ...
    private function getPerbandinganArray($perbandinganPekerjaan)
    {
        $perbandinganArray = [];
        foreach ($perbandinganPekerjaan as $perbandingan) {
